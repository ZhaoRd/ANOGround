    ...
    public class CurrentState : ICloneable
    {
        ...
        public float ch3percent
        {
            get
            {
                ...
                try
                {
                    if (Form1.comPort.MAV.param.ContainsKey("RC3_MIN") &&
                        Form1.comPort.MAV.param.ContainsKey("RC3_MAX"))
                    {
                        return
                            (int)
                                (((ch3out - Form1.comPort.MAV.param["RC3_MIN"].Value) /
                                  (Form1.comPort.MAV.param["RC3_MAX"].Value - Form1.comPort.MAV.param["RC3_MIN"].Value)) *
                                 100);
                    }
                    else
                    {
        ...
        // current firmware
        public Form1.Firmwares firmware = Form1.Firmwares.ArduCopter2;
        ...
        {
            get { return (Form1.comPort.BaseStream.IsOpen || Form1.comPort.logreadmode); }
        }
